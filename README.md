...
- `Σ` is any one letter of the alphabet. If Σ = {0, 1}, `Σ` means `(0|1)` (`\Σ` for a literal Σ).
- The optional **Σ =** box sets the alphabet by hand, e.g. `0, 1, 2` (commas or spaces; braces optional). Left empty, Σ is every letter used in either expression.
